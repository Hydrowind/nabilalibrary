...
<div class="row">
	<div class="col-md-6">
		<div class="content-box-large">
			...
			Selamat datang di perpustakaan, tempat di mana pengetahuan dan imajinasi bersatu. Di sini, halaman buku menyimpan kemungkinan yang tak terbatas dan suasana yang tenang memungkinkan untuk konsentrasi dan refleksi yang dalam. Kami harap Anda menemukan informasi dan inspirasi yang Anda cari di antara rak-rak ini. Apakah Anda di sini untuk belajar, riset, atau hanya untuk menikmati buku yang bagus, kami berharap Anda menikmati kunjungan yang produktif dan menyenangkan.
				<br /><br />
			</div>
		</div>
	</div>
...
Pellentesque id arcu et odio imperdiet laoreet. Nulla sed eros risus. Sed tellus odio, faucibus et odio eu, eleifend aliquet nisl. In porttitor odio pulvinar ligula tempor, bibendum lacinia metus mattis. Donec venenatis, tellus non aliquet lobortis, magna lorem ullamcorper urna, nec posuere metus lacus non tellus. Aenean condimentum, velit ac tincidunt volutpat, dolor metus pulvinar lacus, a commodo massa dolor eget magna. Ut hendrerit lectus sit amet malesuada tincidunt.
<br /><br />
</div>eload"><i class="glyphicon glyphicon-cog"></i></a>
				</div>
				</div>
				<div class="content-box-large box-with-header">
