...
<div class="content-box-large">
    <div class="panel-body">
        <a href="{{ route( 'students.create') }}" class="btn btn-success mb-1 "><i class="fa fa-plus-circle"></i> Buat Data Baru</a> <br><br>
        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route( 'students.edit', $d->id) }}" class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i> Ubah</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route( 'students.destroy', $d->id) }}" method="post" style="display: inline">
                    @method('delete')
                    @csrf
